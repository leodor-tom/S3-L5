...
//console.log(random(20, 0));

/* ESERCIZIO C
  Crea una variabile chiamata "me" e assegnaci un oggetto contenente le seguenti proprietà: name = il tuo nome, surname = il tuo cognome, age = la tua età.
*/
const me = { name: "Tommaso", surname: "Eleodori", age: 20 };
...
// deleteOne("hello", 0 < 10);
//console.log(deleteOne("hello", 20 < 10));
/* ESERCIZIO 5
...
//console.log(onlyLetters("I have 76 dogs "));
/* ESERCIZIO 6
...
//console.log(isThisAnEmail("eleodoritom@gmail.com"));
